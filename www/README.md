...
![AVE.cms](https://gitget.ru/img/1_1.png "AVE.cms")
 ...
 * ПО WEB сервера: 
   ...
   * Nginx >= 1.6.2
   * IIS >= 5
   * PHP >= 5.2.1 ... <= 5.4 (zlib, cURL, mbString, JSON)
...
---
Copyright © 2007-2016 [Ave-Cms.Ru](http://ave-cms.ru) | [AVE.cms 3.0](http://ave-cms.ru)
